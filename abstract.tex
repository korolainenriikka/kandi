...
In the review it is found that in the case studied the ... knowledge retention approach is ideal, and therefore a xxx architecture for stream processing,  ... for model training, and ... for the deployment scheme should be preferred. %add here: more motivation.
