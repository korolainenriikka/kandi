...
when comparing model updating approaches, classifiers are left out. This is because in general in this field classifiers are researched much more than other types of learning and taking classifiers into account would give a false sense of maturity of the approaches as the case studied has only non-classifier models
