...
\cite{szeEfficientProcessingDeep2017} \cite{jia_highly_2018} \cite{de_sa_high-accuracy_2018}: %all until distribution...
...
% in other words: However, noise should not be confused to error induced by reduced precision, as the improvement by noise has only been proven to be there for noise not induced by rounding \cite{an_effects_1996} and classification tasks \cite{murray_enhanced_1994}.
