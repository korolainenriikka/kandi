...
\title{Enabling model adaptation in a big data system: a case study}
...
\keywords{machine learning, adaptive learning, big data systems, maritime}
...
\  Software and its engineering $\rightarrow$ Software notations and tools $\rightarrow$ Software configuration management and version control systems
}}
